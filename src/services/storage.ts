...
import {AuthSession,Complaint,Message,Provider,Request,Review,Service,UserProfile,ProviderAccountStatus,ProviderAvailability} from '../types';
const keys={requests:'fixmate.requests',favourites:'fixmate.favourites',messages:'fixmate.messages',reviews:'fixmate.reviews',profile:'fixmate.profile',providerStatuses:'fixmate.providerStatuses',availability:'fixmate.availability',session:'fixmate.session',complaints:'fixmate.complaints',providers:'fixmate.providers',services:'fixmate.services'};
